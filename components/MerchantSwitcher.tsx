...
const text = {
  th: { label: "ธุรกิจที่กำลังใช้งาน", add: "เพิ่มธุรกิจ", checking: "กำลังตรวจ LINE…", admin: "จัดการข้อมูล", sync: "ซิงค์", syncing: "กำลังซิงค์…", synced: "ซิงค์แล้ว", draft: "ฉบับร่าง", review: "รอตรวจ", published: "เผยแพร่แล้ว", rejected: "ไม่ผ่าน", lineRequired: "ต้องเปิดใน LINE และยืนยันตัวตนก่อนสร้างธุรกิจ", openLine: "เปิดใน LINE", requestError: "ดำเนินการไม่สำเร็จ กรุณาลองอีกครั้ง" },
  en: { label: "Active business", add: "Add business", checking: "Checking LINE…", admin: "Admin", sync: "Sync", syncing: "Syncing…", synced: "Synced", draft: "Draft", review: "In review", published: "Published", rejected: "Rejected", lineRequired: "Open this app inside LINE and verify your identity before creating a business.", openLine: "Open in LINE", requestError: "Request failed. Please try again." },
  zh: { label: "当前商户", add: "创建商户", checking: "正在验证LINE…", admin: "管理后台", sync: "同步", syncing: "同步中…", synced: "已同步", draft: "草稿", review: "待审核", published: "已发布", rejected: "未通过", lineRequired: "创建商户需要在LINE内打开并完成身份验证。", openLine: "在LINE中打开", requestError: "操作失败，请重试" },
};
